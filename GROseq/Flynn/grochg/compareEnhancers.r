gro_se_sense = read.delim("/home/raflynn/7SK/GROseq/Flynn/metagenes/GRO_12Ccomb_sense/bins/SE_indiv/allchr_sorted.txt",header=FALSE,colClasses=c(rep("character",7),rep("numeric",400)))
gro_se_antisense = read.delim("/home/raflynn/7SK/GROseq/Flynn/metagenes/GRO_12Ccomb_antisense/bins/SE_indiv/allchr_sorted.txt",header=FALSE,colClasses=c(rep("character",7),rep("numeric",400)))
...
chirp_se = read.delim("/home/raflynn/7SK/ChIRPseq/metagenes/7SK_mES_WT/bins/SE_indiv/allchr_sorted.txt",header=FALSE,colClasses=c(rep("character",7),rep("numeric",400)))
