...
fenh = getPos("startRNA_NELFwt_forward_pro_tss.bedgraph")
renh = getPos("startRNA_NELFwt_reverse_pro_tss.bedgraph")
...
writer = csv.writer(ofile, 'textdialect')
unfile = open("mm9_tss_individual_startseq_uncentered_1kb.bed",'w')
