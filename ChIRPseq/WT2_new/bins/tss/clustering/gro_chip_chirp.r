...
require(pheatmap)
png("chirp_tss_all.png", width=400, height=800)
...
# gro heatmap
gro12c.sense.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_12C_tss_sense.txt", header=FALSE, nrows=5)
classes <- sapply(gro12c.sense.raw, class)
gro12c.sense.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_12C_tss_sense.txt", header=FALSE, colClasses=classes)
genenames = gro12c.sense.raw[,1]
gro12c.sense.raw = gro12c.sense.raw[,108:308]
...
# gro ASO heatmap
gro123.sense.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_123_tss_sense.txt", header=FALSE, nrows=5)
classes <- sapply(gro123.sense.raw, class)
gro123.sense.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_123_tss_sense.txt", header=FALSE, colClasses=classes)
...
png("gro_12_chg.png", width=400, height=800)
...
# gro heatmap
gro12c.as.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_12C_tss_antisense.txt", header=FALSE, nrows=5)
classes <- sapply(gro12c.as.raw, class)
gro12c.as.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_12C_tss_antisense.txt", header=FALSE, colClasses=classes)
...
# gro ASO heatmap
gro123.as.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_123_tss_antisense.txt", header=FALSE, nrows=5)
classes <- sapply(gro123.as.raw, class)
gro123.as.raw = read.table("/arrayAhome/raflynn/GROseq_ASO/combined/GRO_123_tss_antisense.txt", header=FALSE, colClasses=classes)
