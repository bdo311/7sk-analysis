...
groseqDir = "/home/raflynn/GROseq_ASO/"
...
folders = ['GRO_63', 'GRO_65', 'GRO_6C','GRO_123', 'GRO_125', 'GRO_12C']
seven_Folders = [x + '_plus' for x in folders]
seven_Folders.extend([x + '_minus' for x in folders])
...
for folder in seven_Folders:
	...
	os.system("mkdir tss tes geneBody geneBody_ext super extsuper reg extreg")
...
for folder in seven_Folders:
	binFolder = groseqDir + folder + '/bins/'
	# graph = chirpDir + 'test/mergeMed.bedGraph' #for testing
	graphFolder = groseqDir + folder + '/bedGraphByChr/'
...
top2a = getChrToRegion("/home/raflynn/mmchipseq/top2/Top2a_provided_peaks.bed", 0, False)
...
for folder in folderToGraph:
	...
	for i in range(len(allChroms)):
		...
		regionProcess("geneBody", genes, chroms, 3, 4, True, 2, True, 300, False)
		regionProcess("geneBody_ext", genes, chroms, 3, 4, True, 2, True, 300, True)

		# regionProcess("linc", lincStart, chroms, 1, 2, True, 5, False, 400)
		regionProcess("top2a", top2a, chroms, 1, 2, False, 0, False, 300, True)
		regionProcess("extreg", regEnh, chroms, 1, 2, False, 0, False, 300, True)
		regionProcess("extsuper", superEnh, chroms, 1, 2, False, 0, False, 300, True)
		regionProcess("reg", regEnh, chroms, 1, 2, False, 0, False, 300, False)
		regionProcess("super", superEnh, chroms, 1, 2, False, 0, False, 300, False)
