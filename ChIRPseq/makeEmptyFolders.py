# makeEmptyFolders.py
# 3/5/14, edited 3/26/14 to use for combined.bedGraph, edited 4/8/14 for combined_norm.bedGraph
...
# seven_Folders = ['ActD', 'DRB', 'Flavo', 'JQ11', 'JQ14', 'WT1', 'WT2']
...
chipDir = "/home/raflynn/Mm_ChIPseq/mES_young/"
